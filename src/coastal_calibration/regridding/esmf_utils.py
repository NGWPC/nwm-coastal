...
def build_locstream(lon: np.ndarray, lat: np.ndarray) -> ESMF.LocStream:
    ...
    **locally** on the calling rank, so we must compute the local share
    ...
    locstream._global_lower = local_start
    locstream._global_upper = local_start + local_count
    return locstream
...
class Regridder:
    ...
    def __init__(
        ...
        method: ESMF.RegridMethod = ESMF.RegridMethod.BILINEAR,
        unmapped_action: ESMF.UnmappedAction = ESMF.UnmappedAction.IGNORE,
...
class MaskedRegridder:
    ...
    def __init__(
        self,
        method: ESMF.RegridMethod = ESMF.RegridMethod.NEAREST_STOD,
        unmapped_action: ESMF.UnmappedAction = ESMF.UnmappedAction.IGNORE,
        src_mask_values: list[int] | None = None,
    ):
        self.method = method
