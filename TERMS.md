...
bureau, shall not be used in any manner to imply endorsement of any commercial product
...
_Source code or other assets that are excluded from the TERMS should be listed here.
These may include dependencies that may be licensed differently or are not in the public
domain._
