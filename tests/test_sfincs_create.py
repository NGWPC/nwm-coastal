...
class TestSfincsCreateConfig:
    ...
    def test_validate_missing_reclass_table(
        self, aoi_file: Path, output_dir: Path
    ) -> None:
        cfg = SfincsCreateConfig(
            aoi=aoi_file,
    ...
    def test_to_yaml(
        self, tmp_path: Path, minimal_create_config: SfincsCreateConfig
    ) -> None:
...
class TestSfincsCreator:
    ...
    def test_start_from_stop_after(
        self, minimal_create_config: SfincsCreateConfig
    ) -> None:
        creator = SfincsCreator(minimal_create_config)
    ...
    def test_check_prerequisites_missing(
        self, minimal_create_config: SfincsCreateConfig
    ) -> None:
        creator = SfincsCreator(minimal_create_config)
...
class TestNWMDischargeConfig:
    ...
    def test_validate_missing_gpkg(
        self, aoi_file: Path, output_dir: Path
    ) -> None:
        cfg = SfincsCreateConfig(
            aoi=aoi_file,
    ...
    def test_to_dict_with_discharge(
        self, discharge_create_config: SfincsCreateConfig
    ) -> None:
    ...
    def test_to_dict_without_discharge(
        self, minimal_create_config: SfincsCreateConfig
    ) -> None:
        d = minimal_create_config.to_dict()
...
class TestDischargeStageValidation:
    ...
    def test_validate_skips_when_no_config(
        self, minimal_create_config: SfincsCreateConfig
    ) -> None:
...
class TestDischargeStageRun:
    ...
    def test_run_adds_discharge_points(
        ...
        mock_sfincs_model.quadtree_grid.data.__getitem__ = lambda self, k: mask_mock if k == "mask" else MagicMock()
