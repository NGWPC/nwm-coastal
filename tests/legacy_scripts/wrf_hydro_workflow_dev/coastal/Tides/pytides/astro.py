...
# Meeus formula 45.7
lunar_node_coefficients = (125.0445550, -1934.1361849, 0.0020762, 1 / 467410.0, -1 / 60616000.0)

# Meeus, unnumbered formula directly preceded by 45.7
lunar_perigee_coefficients = (83.3532430, 4069.0137111, -0.0103238, -1 / 80053.0, 1 / 18999000.0)
...
def astro(t):
    ...
    for name, function in {"I": _I, "xi": _xi, "nu": _nu, "nup": _nup, "nupp": _nupp}.items():
    ...
    a["T+h-s"] = AstronomicalParameter(
        hour.value + a["h"].value - a["s"].value, hour.speed + a["h"].speed - a["s"].speed
    )
